 ...
 function post_like(id) {
     ...
     $.ajax({
         ...
         dataType: "HTML",
         success: function(response) {
             $('#post_like_count' + id).html(response + ' Likes');
         }
     });
 }
 ...
 /*-------------------------------
        Video Like
     -------------------------------------*/
 function video_like(id) {
     var url = $("#video_like_url").val();
     $.ajax({
         url: url,
         data: { id: id },
         type: "GET",
         dataType: "HTML",
         success: function(response) {
             $('#video_like_count' + id).html(response);
         }
     });
 }
 ...
 /*-------------------------------
       Video Like
    -------------------------------------*/
 function post_comment_like(id) {
     var url = $("#post_comment_like_url").val();
     $.ajax({
         url: url,
         data: { id: id },
         type: "GET",
         dataType: "HTML",
         success: function(response) {
             $('#post_comment_like_count' + id).html(response);
         }
     });
 }
 ...
 /*-------------------------------
    Show video links
-------------------------------------*/
 function show_video_links(id) {
     $('#videolinks' + id).attr('class', 'video-card-details-info');
 }

 /*-------------------------------
    hide video links
   -------------------------------------*/
 function hide_video_links(id) {
     $('#videolinks' + id).attr('class', 'd-none');
 }

 /*-------------------------------
    Show forum links
 -------------------------------------*/
 function show_forum_links(id) {
     $('#forumlinks' + id).attr('class', 'video-card-details-info');
 }

 /*-------------------------------
    hide forum links
-------------------------------------*/
 function hide_forum_links(id) {
     $('#forumlinks' + id).attr('class', 'd-none');
 }

 /*-------------------------------
    Show posts links
 -------------------------------------*/
 function show_post_links(id) {
     $('#postlinks' + id).attr('class', 'd-inline-block text-muted ml-3');
 }

 /*-------------------------------
    hide posts links
 -------------------------------------*/
 function hide_post_links(id) {
     $('#postlinks' + id).attr('class', 'd-none');
 }