...
<div class="modal fade" id="wallet" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content paypal-balance">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">{{ __('My balance') }} <span class="balance_color">{{ $currency_value->symbol }}{{ number_format($user_data->wallet,2) }}</span></h5>
