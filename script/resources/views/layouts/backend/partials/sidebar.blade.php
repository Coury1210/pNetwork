<div class="main-sidebar">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="nav-item dropdown {{ Request::is('admin/sponsor*') ? 'active' : '' }}">
        <a href="#" class="nav-link has-dropdown"><i class="fas fa-project-diagram"></i> <span>{{ __('Savings Products') }}</span></a>
        <ul class="dropdown-menu">
          <li><a class="nav-link {{ Request::is('admin/savings/products/create') ? 'active' : '' }}" href="{{ route('admin.savingsProducts.create') }}">{{ __('Add Savings Products') }}</a></li>
          {{-- <li><a class="nav-link {{ Request::is('admin/savings/products') ? 'active' : '' }}" href="{{ route('admin.savingsProducts.edit') }}">{{ __('Edit Savings Products') }}</a></li> --}}
          <li><a class="nav-link {{ Request::is('admin/savings/products') ? 'active' : '' }}" href="{{ route('admin.savingsProducts.index') }}">{{ __('Manage Savings Products') }}</a></li>
        </ul>
      </li>
