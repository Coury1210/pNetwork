    ...
    <div class="main-area pt-50">
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                <div class="center">
                    <p>This Privacy Policy governs the manner in which {{env('APP_NAME')}} collects, uses, maintains and discloses information collected from users (each, a "User") of this website ("Site"). This privacy policy applies to the Site and all products and services offered by {{env('APP_NAME')}}.</p>
                    <p>&nbsp;</p>
                    ...
                    <p>{{env('APP_NAME')}} collects and uses Users personal information for the following purposes:</p>
                    <ul>
                    <li><em>- To personalize user experience</em><br />
                        <p>We may use information in the aggregate to understand how our Users as a group use the services and resources provided on our Site.</p></li>
                    <li><em>- To improve our Site</em><br />
                        <p>We continually strive to improve our website offerings based on the information and feedback we receive from you.</p></li>
                    <li><em>- To improve customer service</em><br />
                        <p>Your information helps us to more effectively respond to your customer service requests and support needs.</p></li>
                    ...
                    <p>{{env('APP_NAME')}} has the discretion to update this privacy policy at any time. When we do, we will revise the updated date at the bottom of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
                    <p>&nbsp;</p>
                    
                    <p><strong>Your acceptance of these terms</strong></p>
                    <p>By using this Site, you signify your acceptance of this policy and <a href="{{ route('terms') }}">terms of service</a>.<br />
                    ...
                    privacy practices of this site, please contact us via our &quot;<a href="{{ route('contact') }}" title="Contact Us">contact form</a>&quot;.</p>
                    <p>&nbsp;</p>
                </div>
                </div>
