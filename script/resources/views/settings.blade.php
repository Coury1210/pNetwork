			...
			<div class="row">
						...
						<div class="settings-main-menu">
							<nav>
								<ul class="nav nav-tabs">
									...
									@endphp
									<li><a href="#payment-method" class="active" data-toggle="tab"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-dollar-sign"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg> {{ __('Payment Method') }}</a></li>
				...
				<div class="col-lg-8">
					<div class="tab-content">
						<div class="setting-main-area tab-pane fade in" id="avatar">
										...
										<div class="col-lg-12">
											<div class="monetization-area text-center">
												...
												<div class="monetization-info">
													<p> {{ config('constants.message.monetization') }}</p>
												</div>
						...
						<div class="setting-main-area tab-pane fade in active show" id="payment-method">
							<form action="{{ route('profile.payment_method') }}" method="POST" id="payment_method_form">
								@csrf
								<div class="settings-content-area">
											...
											<div class="col-lg-12">
												<div class="form-group">
													<select class="form-control" name="payment_method">
														...
														<option value="Flutter Wave">Flutter Wave</option>
													</select>
												</div>
											</div>
										</div>
										<div class="settings-btn">
											<button id="payment_method_button" type="submit f-right">{{ __('Submit') }}</button>
										</div>
									</div>
								</div>
							</form>
